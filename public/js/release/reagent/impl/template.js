...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7023__auto__,writer__7024__auto__,opt__7025__auto__){
return cljs.core._write.call(null,writer__7024__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__17391 = o;
(G__17391[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__17392__delegate = function (args){
...
while (G__17393__i < G__17393__a.length) {G__17393__a[G__17393__i] = arguments[G__17393__i + 0]; ++G__17393__i;}
  args = new cljs.core.IndexedSeq(G__17393__a,0);
} 
return G__17392__delegate.call(this,args);};
G__17392.cljs$lang$maxFixedArity = 0;
G__17392.cljs$lang$applyTo = (function (arglist__17394){
var args = cljs.core.seq(arglist__17394);
return G__17392__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__6405__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__6405__auto__){
var and__6405__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__17400 = jsprops;
(G__17400["defaultValue"] = value);

(G__17400["onChange"] = ((function (G__17400,v,value,on_change){
return (function (p1__17397_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__17397_SHARP_);
});})(G__17400,v,value,on_change))
);

(G__17400["ref"] = ((function (G__17400,v,value,on_change){
return (function (p1__17398_SHARP_){
return (this$["cljsInputElement"] = p1__17398_SHARP_);
});})(G__17400,v,value,on_change))
);
...
var vec__17407 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__17407,(0),null);
var id = cljs.core.nth.call(null,vec__17407,(1),null);
var class$ = cljs.core.nth.call(null,vec__17407,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___17412 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___17412 == null)){
} else {
var key_17413 = temp__4661__auto___17412;
(jsprops["key"] = key_17413);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__17415 = (new reagent.impl.template.NativeWrapper());
(G__17415["name"] = c);
...
var len__7492__auto___17421 = arguments.length;
var i__7493__auto___17422 = (0);
while(true){
if((i__7493__auto___17422 < len__7492__auto___17421)){
args__7499__auto__.push((arguments[i__7493__auto___17422]));

var G__17423 = (i__7493__auto___17422 + (1));
i__7493__auto___17422 = G__17423;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7500__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq17419){
var G__17420 = cljs.core.first.call(null,seq17419);
var seq17419__$1 = cljs.core.next.call(null,seq17419);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__17420,seq17419__$1);
});
...
break;
default:
var G__17427 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__17427;
continue;
...
var n__7332__auto___17430 = a.length;
var i_17431 = (0);
while(true){
if((i_17431 < n__7332__auto___17430)){
(a[i_17431] = reagent.impl.template.as_element.call(null,(a[i_17431])));
...
var a = cljs.core.into_array.call(null,s);
var n__7332__auto___17433 = a.length;
var i_17434 = (0);
while(true){
if((i_17434 < n__7332__auto___17433)){
var val_17435 = (a[i_17434]);
if((cljs.core.vector_QMARK_.call(null,val_17435)) && ((reagent.impl.template.key_from_vec.call(null,val_17435) == null))){
(o["no-key"] = true);
} else {
}

(a[i_17434] = reagent.impl.template.as_element.call(null,val_17435));

var G__17436 = (i_17434 + (1));
i_17434 = G__17436;
continue;
} else {
}
...
var ctx = ({});
var vec__17440 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__17440,(0),null);
var derefed = cljs.core.nth.call(null,vec__17440,(1),null);
...
var G__17444 = (cljs.core.count.call(null,argv) - first_child);
switch (G__17444) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__17444){
